    ...
    return(
        <section id="s-projects">
            <Container className="d-flex justify-content-center align-items-center mb-5 mt-5">
                <Container fluid className={`bg-dark p-5 rounded ${styles.mainContainer}`}>
                    <h1 className='fw-bold'>{projectsTitle}</h1>
                    <Row className="mb-4">
                        <Col xs={12}><Buttons event={()=>setView(!View)} text='Destaques'/></Col>
                        {View?(
                            <Renderprojects itens={teste}/>
                        ):(
                            <>
                            </>
                        )}
                    ...
                    <Row>
                        <Col xs={12}><Buttons text='Todos'/></Col>
                    </Row>
                </Container>
            </Container>
        </section>
